...
<head>
  ...
  <title>Company Login | InternsHub</title>
  <!-- Bootstrap core CSS-->
      ...
      <div class="card-body">
        <form action="login.php" method="post">
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Enter email" name="userEmail">
          </div>
          <div class="form-group">
