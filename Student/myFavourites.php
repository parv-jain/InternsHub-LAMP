...
$favourites = getStudentFavouriteInternshipsByStudentId($studentId);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <div class="content">
                ...
                foreach ($favourites as $favourite) {
                  $internshipDetails = getInternshipDetailsByInternshipId($favourite['Internship_Id']);
                  ?>
                      ...
                      <div class="collapse" id="<?php echo 'view-leaderboard-'.$internshipDetails['Internship_Id'] ?>">
                          <div class="card card-body">
                              ...
                              <table class="table table-responsive">
                                  ...
                                  <tbody>
                                    <?php
                                      $leaderBoard = getRankWiseOrder($favourite['Internship_Id']);
                                      $rank = 0;
