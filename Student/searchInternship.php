...
$allInternships = getAllDataFromTable("internships");
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- FILTERS: START -->
            <div id="filters">
                <div class="filter-heading row text-white bg-dark d-flex">
                    <div class="mr-auto p-2">
                        <h4>Filters</h4>
                    </div>
                </div>

                <div class="border border-secondary row text-white bg-dark filter-body">
                    ...
                    <div class="form-group col-md-3 col-sm-6 col-xs-12">
                        <label class="my-1 mr-2" for="location">Duration</label>
                        <select class="custom-select my-1 mr-sm-2" id="duration">
                    ...
                    <div class="form-group col-md-3 col-sm-6 col-xs-12">
                        <label class="my-1 mr-2" for="location">Type</label>
...
$(document).ready(function(){
  $('#category').on('change',function(){
    ...
    $.ajax({
        type:'GET',
        url:'executeFilters.php',
        data:'categoryId='+categoryId+'&locationId='+locationId+'&durationId='+durationId+'&typeId='+typeId,
